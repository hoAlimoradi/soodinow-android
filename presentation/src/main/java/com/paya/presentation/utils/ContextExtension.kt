...
fun Context.getDrawableByResId(resId: Int): Drawable? =  ContextCompat.getDrawable(this,resId)

fun Context.getColorByResId(id: Int) : Int = ContextCompat.getColor(this, id)

...
class CustomRadioGroup: LinearLayout {
    ...
    private var mChildOnCheckedChangeListener: CustomRadioCheckable.OnCheckedChangeListener? = null
    ...
    override fun addView(child: View, index: Int, params: ViewGroup.LayoutParams) {
        if (child is CustomRadioCheckable) {
            val button = child as CustomRadioCheckable
            if (button.isChecked) {
    ...
    private fun setCheckedStateForView(viewId: Int, checked: Boolean) {
        ...
        if (checkedView != null && checkedView is CustomRadioCheckable) {
            (checkedView as CustomRadioCheckable).setChecked(checked)
        }
    }
    ...
    // Inner classes
    //================================================================================
    private inner class CheckedStateTracker : CustomRadioCheckable.OnCheckedChangeListener {
    ...
    private inner class PassThroughHierarchyChangeListener : ViewGroup.OnHierarchyChangeListener {
        ...
        override fun onChildViewAdded(parent: View, child: View) {
            if (parent === this@CustomRadioGroup && child is CustomRadioCheckable) {
                var id = child.id
                ...
                (child as CustomRadioCheckable).addOnCheckChangeListener(
        ...
        override fun onChildViewRemoved(parent: View, child: View) {
            if (parent === this@CustomRadioGroup && child is CustomRadioCheckable) {
                (child as CustomRadioCheckable).removeOnCheckChangeListener(mChildOnCheckedChangeListener)
            }

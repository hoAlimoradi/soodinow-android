...
class RectangleView @JvmOverloads
constructor(
...
//For coordinates location relative to the screen/display
        this.parentView.getGlobalVisibleRect(rectf)

        Log.e("WIDTH        :", String.valueOf(rectf.width()))
        Log.e("HEIGHT       :", String.valueOf(rectf.height()))
        Log.e("left         :", String.valueOf(rectf.left))
        Log.e("right        :", String.valueOf(rectf.right))
        Log.e("top          :", String.valueOf(rectf.top))
        Log.e("bottom       :", String.valueOf(rectf.bottom))
    }*/

    val percentList = listOf(40, 30, 30)
    ...
    //    image resources
    private var imageResourceUri = R.drawable.ic_image_chat
...
/*        drawImage(canvas)
    ...
    private fun drawCards(canvas: Canvas?) {
        ...
        percentList.forEach { percent ->


        }
        rectWidth = viewWidth - 0f
        canvas?.drawRoundRect(0f, 0f, rectWidth, rectHeight, 0f, 0f, cardPaint)
    }
    ...
    private fun drawDetailsText(canvas: Canvas?, text: kotlin.String, fromTop: Int) {
        canvas?.let {
    ...
    private fun drawBigDetailsText(canvas: Canvas?, text: kotlin.String, fromTop: Int) {
        canvas?.let {
